...
const MyProducts = () => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        // send GET to https://marketplace-crud.onrender.com/api/products/my-products with the token in the header
        const trimmedToken = user.replace(/['"]+/g, "");
        const bearerToken = `Bearer ${trimmedToken}`;
        // console.log(bearerToken);

        const response = await axios.get(
          "https://marketplace-crud.onrender.com/api/products/my-products",
          {
            headers: {
